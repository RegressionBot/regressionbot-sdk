...
export class Visual {
    ...
    public async _request<T>(path: string, method: string = 'GET', body?: any): Promise<T> {
        ...
        try {
            ...
            // [SECURITY] Re-throw error to ensure calling function handles it;
            // AbortController prevents hanging/DoS.
            throw error;
        } finally {
    ...
    public async downloadResults(options: { 
        ...
        const download = async (url: string, name: string) => {
            ...
            try {
                ...
                // [SECURITY] Re-throw error; AbortController prevents hanging/DoS.
                throw error;
            } finally {
                clearTimeout(timeout);
            }
